        ...
        <>
            <div className='grid grid-cols-3 gap-5'>
                {recommendationRestaurant.slice(0, next).map(item =>
                    <div key={item.id} className='flex flex-col justify-between h-[355px] border drop-shadow-md rounded-lg bg-whiteBackground'>
                        <img src={item.img} alt={item.name} loading='lazy' className='rounded-t-lg object-cover w-full h-52' />
