    ...
    function ItemContent() {
        return (
            <div className='border drop-shadow-md rounded-lg bg-whiteBackground' >
                <img src={moreInformation.img} alt={moreInformation.name} className='rounded-t-lg object-contain' />
                <Link to={`..${search}`} relative='path' className='flex mt-2 pl-4'>
                    <button className='border border-buttonBorder hover:bg-buttonHover rounded-md py-2 px-4'>
                        <span className='text-buttonColor text-base font-medium'>&larr; BACK TO {searchCategory}</span>
                    </button>
                </Link>
                <div className='flex justify-between'>
                    <div className='flex flex-col flex-wrap justify-center items-start px-4'>
                        ...
                        {moreInformation.location ?
                            <h4 className='text-textSecondColor text-xl'>{moreInformation.location}
                            </h4> : <h4 className='text-textSecondColor text-xl'>Most iconic:</h4>}
                    </div>
                    <div className='my-8 px-4'>
                        <img src={moreInformation.map} alt={moreInformation.name} className='object-cover w-[150px]' />
                    </div>
                </div>
