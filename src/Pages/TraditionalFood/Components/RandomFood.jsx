...
const RandomFood = ({ randomFood, designClass }) => {
    ...
    return (
        <div className={` flex justify-between ${designClass} basis-1 my-4  border drop-shadow-md  rounded-lg bg-whiteBackground`}>
            ...
            <div className="basis-1/2">
                <img src={randomFood.img} alt={randomFood.name} className={`object-cover h-full ${designClass}`} />
            </div>
        </div>
    )
}
