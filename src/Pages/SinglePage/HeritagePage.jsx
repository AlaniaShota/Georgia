    ...
    <div>
      ...
      <div className="my-20 lg:container sm:mx-8 lg:mx-0 ">
        <div className="flex flex-col justify-center items-start mb-10">
          ...
          />
          <p className="mb-4 text-secondColor">{Testament_First_Description}</p>
          <p className="mb-4 text-secondColor">
            {Testament_Second_Description}
          </p>
          <p className="mb-4 text-secondColor">{Testament_Third_Description}</p>
          <p className="mb-4 text-secondColor">
            {Testament_Fourth_Description}
          </p>
        </div>
        <div className="flex flex-col justify-center items-start my-10">
          ...
          <img
            ...
            className="mb-6 object-cover rounded-md drop-shadow-md"
          />
          <p className="mb-4 text-secondColor">{Vine_Clay_First_Description}</p>
          <p className="mb-4 text-secondColor">
            {Vine_Clay_Second_Description}
          </p>
        </div>
        <div className="flex flex-col justify-center items-start my-10">
          ...
          <img
            ...
            className="mb-6 object-cover rounded-md drop-shadow-md"
          />
          <p className="mb-4 text-secondColor">{Wine_Song_First_Description}</p>
          <p className="mb-4 text-secondColor">
            {Wine_Song_Second_Description}
          </p>
        </div>
        <div className="flex flex-col justify-center items-start my-10">
          ...
          <img
            ...
            className="mb-6 object-cover rounded-md drop-shadow-md"
          />
          <h3 className="mb-4 text-secondColor">{Wine_Food_Word}</h3>
          <p className="mb-4 text-secondColor">{Wine_Food_First_Description}</p>
          <p className="mb-4 text-secondColor">
            {Wine_Food_Second_Description}
          </p>
          <p className="mb-4 text-secondColor">{Wine_Food_Third_Description}</p>
        </div>
      </div>
    </div>
  );
