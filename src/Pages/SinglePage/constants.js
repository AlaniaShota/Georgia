...
export const Dance_Title = "Georgian National Dance";
export const Dance_Description =
  "Georgia folk dance has a vast history and is well-known for its dances in many countries. Today, audiences in more than a few countries of the world applaud Georgian dance with its beautiful steps, complicated jumping movements, fiery music, and heroic daring.";
export const Dance_Era_Title = "Georgian Dance before the Common Era";
export const Dance_Era_First_Description =
...
export const Dance_Era_Second_Description =
...
export const Dance_Era_Third_Description =
...
export const Dance_Era_Fourth_Description =
...
export const Dance_Universal_Title =
  "What Is the Secret to the Universal Acclaim of Georgian Dance? ";
export const Dance_Universal_First_Description =
...
export const Dance_Universal_Second_Description =
...
export const Dance_Universal_Third_Description =
...
export const Folk_Title = "The Unique Georgian Folklore";
export const Folk_Description =
  "Do you know who the inspiration for Prometheus was, or where Zeus had him chained? Where the Golden Fleece was kept until Jason and his Argonauts came to claim it? Are you familiar with Medea, whose name is the root of the word medicine? Have you perhaps heard of the song, Chakrulo, and its journey into space?";
export const Mountain_Title = "The Beginning of the Mountains";
export const Mountain_First_Description =
...
export const Mountain_Second_Description =
...
export const Mountain_Third_Description =
...
export const Mountain_Fourth_Description =
...
export const Poetry_Title = "Poetry and Folk Tales";
export const Poetry_First_Description =
...
export const Poetry_Second_Description =
...
export const Poetry_Third_Description =
...
export const Song_Title = "A Georgian Song That Flew Up into the Sky";
export const Song_First_Description =
...
export const Song_Second_Description =
...
export const Song_Third_Description =
...
export const Song_Fourth_Description =
...
export const Genius_Title = "The Genius of Georgia, Disseminated through Dance";
export const Genius_First_Description =
  "The brilliant Georgian writer Grigol Robakidze called Georgian dance “the genius of Georgia, disseminated through dance”, and it is an apt description! The spirit of the nation and even every letter of our alphabet is expressed through Georgian dance. The country will quite literally tell you its entire history through the medium of dance.";
export const Genius_Second_Description =
...
export const Genius_Third_Description =
