...
export const Folk_Title = "Unique Folklore";
export const Folk_Description =
  "Georgian songs are as ancient as Georgia itself. Here, every region has its own sound, but all share one thing in common: structured polyphony. Georgia was one of the first places in the Christian world to lay the groundwork for three-part harmonies in church music. In 1966, NASA sent the “Golden Record” into space, on which were recorded masterpieces of human creativity, including “Chakrulo,” a treasure of Georgian folk polyphony. In addition, Georgian polyphony has been protected by UNESCO since 2008.";
