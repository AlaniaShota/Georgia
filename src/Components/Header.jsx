...
const Header = () => {
    ...
    return (
        <div
            className={`shadow-md fixed w-full top-0 px-6 py-3 flex z-50 transition-colors duration-500 ease-in ${scrolled ? 'bg-white' : 'bg-transparent'}`}
        >
            <header className='flex lg:items-center lg:justify-between lg:flex-row sm:flex-col w-full  text-xl  text-whiteText '>
                <div className='flex flex-row justify-between items-center'>
                    <Link to='/' className='flex items-center'>
                        ...
                        <span className={`ml-2 transition-colors duration-500 ease-in ${scrolled ? 'text-black' : ''}`}>GEORGIA</span>
                    </Link>
                ...
                <div className={`flex sm:flex-col lg:flex-row sm:static sm:items-start sm:w-auto transition-colors duration-500 ease-in ${scrolled ? 'text-black' : ''} ${open ? 'sm:opacity-100' : 'sm:hidden lg:inline'} `}>
                    ...
                    <Link to='traditional-food' className=' mr-4 py-1 lg:px-4 sm:px-14'>Traditional Food Drink</Link>
